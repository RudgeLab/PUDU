...
class setup:
    ...
    DoubleDilutionColony1Tube1 :int
        For diluting the colony1 the first time, which tube is choosen on the rack. By default, 0
    DoubleDilutionColony1Tube2 :int
        For diluting the colony1 the second time, which tube is choosen on the rack. By default, 1
    DoubleDilutionColony2Tube1 :int
        For diluting the colony2 the first time, which tube is choosen on the rack. By default, 2
    DoubleDilutionColony2Tube2 :int
        For diluting the colony2 the second time, which tube is choosen on the rack. By default, 3
    SingleDilutionColony1 :int
        For diluting the colony1 once, which tube is choosen on the rack. By default, 4
    SingleDilutionColony2 :int
        For diluting the colony2 once, which tube is choosen on the rack. By default, 4
    ...
    def __init__(self,
        ...
        DoubleDilutionColony1Tube1:int=0,
        DoubleDilutionColony1Tube2:int=1,
        DoubleDilutionColony2Tube1:int=2,
        DoubleDilutionColony2Tube2:int=3,
        SingleDilutionColony1:int=4,
        SingleDilutionColony2:int=5):
        ...
        self.DoubleDilutionColony1Tube1=DoubleDilutionColony1Tube1
        self.DoubleDilutionColony1Tube2=DoubleDilutionColony1Tube2
        self.DoubleDilutionColony2Tube1=DoubleDilutionColony2Tube1
        self.DoubleDilutionColony2Tube2=DoubleDilutionColony2Tube2
        self.SingleDilutionColony1=SingleDilutionColony1
        self.SingleDilutionColony2=SingleDilutionColony2
...
def run(protocol):
    ...
    doubleDilution(hs_mod, hs_plate, media_plate, tubeRack, pip, store, setup().kan_location, setup().spec_location, DoubleDilutionColony1Tube1, DoubleDilutionColony1Tube2, setup().desired_columns, setup().colony1_start_dest_well, plate_2)
    estimateCountTip(tips_300, protocol, 96, pip, setup().desired_columns, setup().desired_replicates, 0)
    doubleDilution(hs_mod, hs_plate, media_plate, tubeRack, pip, store, setup().kan_location, setup().spec_location, DoubleDilutionColony2Tube1, DoubleDilutionColony2Tube2, setup().desired_columns, setup().colony2_start_dest_well, plate_2)
    ...
    estimateCountTip(tips_300, protocol, 96, pip, setup().desired_columns, setup().desired_replicates, 0)
    singleDilution(hs_mod, hs_plate, media_plate, tubeRack, pip, store, setup().kan_location, setup().spec_location, SingleDilutionColony1, setup().desired_columns, setup().colony1_start_dest_well, plate_2)
    estimateCountTip(tips_300, protocol, 96, pip, setup().desired_columns, setup().desired_replicates, 0)
    singleDilution(hs_mod,hs_plate, media_plate, tubeRack, pip, store, setup().kan_location, setup().spec_location, SingleDilutionColony2, setup().desired_columns, setup().colony2_start_dest_well,plate_2)
    ...
    #step 9, PBS mixture
    #stop state PBS as media, freeze the states as is 
...
def hsTransfer(hs_mod): #pipette from heater-shaker (ie stop the shaking)
    hs_mod.deactivate_shaker()
    
def hsTransferMod(hs_mod): #transfer wellplate from heater-shaker module
    hs_mod.close_labware_latch() 
    hs_mod.deactivate_shaker()
    hs_mod.open_labware_latch()
